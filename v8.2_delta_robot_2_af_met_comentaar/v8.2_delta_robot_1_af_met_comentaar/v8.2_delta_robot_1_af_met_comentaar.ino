...
#define PI 3.1415926535897932384626433832795  //PI wordt gedefineerd en ook wiskundige libraries opgeroepen en hoe arduino moet omgaan met servos en de servo benoemd
#include <stdio.h>
#include <stdlib.h>
#include <Servo.h>
Servo myservo;
...
void setup() {                  //wat aan welke pin de servo zit
  Serial.begin(9600);
  myservo.attach(9);
  pinMode(9,OUTPUT);
}
